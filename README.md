...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-base-nullary-strided1d-dispatch/tags). For example,

```javascript
NullaryStrided1dDispatch = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-nullary-strided1d-dispatch@v0.1.1-umd/browser.js' )
```
